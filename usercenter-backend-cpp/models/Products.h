...
class Products
{
  public:
    struct Cols
    {
        static const std::string _product_no;
    ...
    /**  For column product_no  */
    ///Get the value of the column product_no, returns the default value if the column is null
    const int32_t &getValueOfProductNo() const noexcept;
    ///Return a shared_ptr object pointing to the column const value, or an empty shared_ptr object if the column is null
    const std::shared_ptr<int32_t> &getProductNo() const noexcept;
    ///Set the value of the column product_no
    void setProductNo(const int32_t &pProductNo) noexcept;
    void setProductNoToNull() noexcept;
  ...
  private:
    ...
    std::shared_ptr<int32_t> productNo_;
