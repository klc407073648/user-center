...
{"userAccount","std::string","varchar(256)",256,0,0,0},
...
User::User(const Json::Value &pJson, const std::vector<std::string> &pMasqueradingVector) noexcept(false)
{
    ...
    if(!pMasqueradingVector[1].empty() && pJson.isMember(pMasqueradingVector[1]))
    {
        ...
        {
            id_=std::make_shared<int64_t>((int64_t)pJson[pMasqueradingVector[1]].asInt64());
        }
    }
    ...
    if(!pMasqueradingVector[5].empty() && pJson.isMember(pMasqueradingVector[5]))
    {
        ...
        {
            userpassword_=std::make_shared<std::string>(pJson[pMasqueradingVector[5]].asString());
        }
    }
    if(!pMasqueradingVector[6].empty() && pJson.isMember(pMasqueradingVector[6]))
    {
        ...
        {
            iphone_=std::make_shared<std::string>(pJson[pMasqueradingVector[6]].asString());
        }
    }
...
void User::setUseraccountToNull() noexcept
{
    useraccount_.reset();
    dirtyFlag_[2] = true;
}
    ...
    const std::vector<std::string> &pMasqueradingVector) const
{
    ...
    if(pMasqueradingVector.size() == 14)
    {
        ...
        if(!pMasqueradingVector[1].empty())
        {
            if(getId())
            {
                ret[pMasqueradingVector[1]]=(Json::Int64)getValueOfId();
            }
            else
            {
        ...
        if(!pMasqueradingVector[5].empty())
        {
            if(getUserpassword())
            {
                ret[pMasqueradingVector[5]]=getValueOfUserpassword();
            }
            else
            {
        ...
        if(!pMasqueradingVector[6].empty())
        {
            if(getIphone())
            {
                ret[pMasqueradingVector[6]]=getValueOfIphone();
            }
            else
            {
...
bool User::validateJsonForCreation(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("avatarUrl"))
    {
        if(!validJsonOfField(3, "avatarUrl", pJson["avatarUrl"], err, true))
            return false;
    }
    if(pJson.isMember("gender"))
    {
    ...
    if(pJson.isMember("userPassword"))
    {
        if(!validJsonOfField(5, "userPassword", pJson["userPassword"], err, true))
            return false;
    }
    else
    {
    ...
    if(pJson.isMember("iphone"))
    {
        if(!validJsonOfField(6, "iphone", pJson["iphone"], err, true))
            return false;
    }
    if(pJson.isMember("email"))
    {
...
bool User::validateJsonForUpdate(const Json::Value &pJson, std::string &err)
{
    ...
    if(pJson.isMember("avatarUrl"))
    {
        if(!validJsonOfField(3, "avatarUrl", pJson["avatarUrl"], err, false))
            return false;
    }
    if(pJson.isMember("gender"))
    {
    ...
    if(pJson.isMember("userPassword"))
    {
        if(!validJsonOfField(5, "userPassword", pJson["userPassword"], err, false))
            return false;
    }
    if(pJson.isMember("iphone"))
    {
        if(!validJsonOfField(6, "iphone", pJson["iphone"], err, false))
            return false;
    }
    if(pJson.isMember("email"))
    {
